            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="px-2 py-1.5 rounded bg-slate-100 border border-slate-200 text-xs text-slate-700 flex items-center gap-1 whitespace-nowrap max-w-[50%] truncate">
                    <Check className="w-3.5 h-3.5 text-emerald-600 flex-shrink-0" />
                    {sinovNatija || "tur yo'q"}
                  </span>
                </div>
              </div>
            </div>
